              ...
              <Card>
                ...
                <CardContent className="h-[56vh] overflow-y-auto">
                  <div className="grid gap-2">
                    ...
                    <div className="flex items-start gap-2">
                      <div className="rounded-full bg-[#ffeaa7] w-8 h-8 flex items-center justify-center text-xl">
                        🎸
                      </div>
                      <div>
                        <div className="font-medium">
                          Ed Sheeran Tour Tickets Sold Out
                        </div>
                        <div className="text-xs text-muted-foreground">
                    ...
                    <div className="flex items-start gap-2">
                      <div className="rounded-full bg-[#fdcb6e] w-8 h-8 flex items-center justify-center text-xl">
                        🎹
                      </div>
                      <div>
                        <div className="font-medium">
